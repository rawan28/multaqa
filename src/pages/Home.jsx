...
export default function Home() {
  ...
  const matches = useMemo(() => professionals.filter((item) => item.is_active === true && `${item.full_name} ${item.location}`.toLowerCase().includes(query.toLowerCase()) && (!specialty || item.specialty === specialty)), [professionals, query, specialty]);
